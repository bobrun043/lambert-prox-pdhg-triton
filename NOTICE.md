...
Known prior art includes Lambert W methods, proximal splitting, PDHG, total-variation regularization, PyTorch, Triton, and GPU kernel fusion. No priority claim is made for those components. The repository's contribution is limited to the particular correctness-first integration and validation architecture documented here.
